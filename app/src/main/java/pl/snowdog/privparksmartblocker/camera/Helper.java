 ...
 *
 * NOTE: The normal codelab flow won't require you to change anything in this class,
 * although you are welcome to read and understand it.
 *
 */
public class Helper {
...
//        final File internalStorage =context.getFilesDir();
//
//        final File file = new File(internalStorage, "tensorflow_preview.png");
//        if (!file.exists()) {
//            if (!file.mkdirs()) {
//                Log.e(TAG, "Could not create storage directory: " + file.getAbsolutePath());
//
//            }
//        }
